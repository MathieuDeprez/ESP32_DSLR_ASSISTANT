...
ScreenItem            *messageScreenItems[]   = { &siFirst, &siSecond };
...
ScreenItem            *mainMenuScreenItems[]   = { &siIntervalometer, &siSettings };
...
ScreenItem            *timerSettingsScreenItems[]   = { &siSelf, &siFrames, &siBkt, &siInterval, &siRun, &siExit };
Screen                timerSettingsScreen(6, (ScreenItem*)timerSettingsScreenItems);
#else
ScreenItem            *timerSettingsScreenItems[]   = { &siSelf, &siFrames, &siBkt, &siInterval, &siRun };
...
ScreenItem            *scitmSelfTimerSet[]   = { &siSelfTimer, &siHourSelf, &siMinSelf, &siSecSelf };
...
ScreenItem            *scitmFramesSet[]   = { &siFramesText, &siFramesCount };
...
ScreenItem            *scitmBkt[]   = { &siBracketing, &siBktEV, &siBktStep };
...
ScreenItem            *scitmIntTimerSet[]   = { &siIntTimer, &siHourInt, &siMinInt, &siSecInt };
...
ScreenItem            *scitmRun[]   = { &siRunLeftTime, &siRunIntTime, &siRunFramesLeft, &siAbort };
...
ScreenItem            *scitmSettings[]   = { &siMode, &siAperture, &siWb, &siShutterSpeed, &siPStyle, &siIso, &siExpComp };
